                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                            ...
                            <div class="mt-2">
                                <p class="text-sm text-gray-500 mb-3">
                                    Escribe la decisión final sobre esta disputa. Este mensaje será enviado al Cliente y
                                    al
                                    Experto.
                                </p>
                                ...
                                @error('resolutionText') <span class="text-red-500 text-xs mt-1 block">{{ $message
                                    }}</span>
                                @enderror
                            </div>
                        </div>
